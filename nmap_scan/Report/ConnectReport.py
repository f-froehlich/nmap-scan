...
class ConnectReport(Report):
    ...
    @staticmethod
    def from_dict(d: Mapping[str, any]):
        try:
            return ConnectReport(ConnectReport.dict_to_xml(d, False))
    ...
    def from_json_file(filepath: str) -> T:
        ...
        return ConnectReport(ConnectReport.dict_to_xml(data))
